	...
	return (
		<>
			<div class='px-10 lg:px-14 xl:px-16'>
				...
				At AIC RAISE, we firmly believe in the power of innovation and the significance of intellectual property rights (IPR) in shaping the future of businesses and individuals. The Innovation & Patent Cell (IPC) has been established with the primary objective of nurturing and securing the intellectual creations of our talented startups and highly potential entrepreneurs of AIC RAISE.
				</p>
			</div>
			<div class='grid grid-cols-1 md:grid-cols-3 px-10 lg:px-14 xl:px-16'>
				<div class='p-8'>
					...
					To assist incubatees in identifying and safeguarding their innovative ideas, inventions, and creations
					</p>
					{/* <a
				...
				<div class='p-8'>
					...
					<p class='font-light text-sm text-gray-500 mb-3'>
					To encourage startups and entrepreneurs to go for patentable works
				...
				<div class='p-8'>
					...
					<p class='font-light text-sm text-gray-500 mb-3'>
					Regular workshops, seminars, and training sessions are organized to educate entrepreneurs on IP-related best practices and legal considerations.
