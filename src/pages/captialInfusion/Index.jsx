  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center p-32 relative finance">
        ...
        <p className="bg-[#f6f6f6] p-8 border-black border-2  leading-8 shadow-md z-10  w-4/6">
          Welcome to SIIF, your premier destination for capital
          infusion solutions. Whether you're a startup aiming to scale or an
          established business seeking expansion, we provide tailored financing
          options to fuel your growth. With our expertise and flexible approach,
          we're here to be your trusted partner on the journey to success. Get
          in touch today to explore how we can help elevate your business.
        </p>
      </div>
