...
const TextRevealOnScroll = ({ text }) => {
  ...
  <div className='w-full h-[260px] relative flex items-center justify-center'>
      ...
      >  <video autoPlay muted loop className='video absolute w-full h-full object-cover left-0 top-0' src={video}/>
        <h1 className='font-bold text-4xl line  absolute w-full h-full left-0 top-0'>
