...
export const HomePage = () => {
  return (
    <div>
      ...
      <div className="bg-black  py-[5rem] md:py-[8rem] flex justify-center items-center relative ">
        <img
      ...
      <div className=" w-[90%] lg:w-[80%] relative m-10  flex flex-col lg:flex-row mx-auto items-center">
        ...
        <div className="w-full lg:w-2/6 flex-col flex items-center  justify-items-start p-10 md:p-14 z-10">
          ...
          <p className="text-center">
            SIIF is a dynamic initiative dedicated to nurturing entrepreneurial
            talents, providing a one-stop center for startups to flourish and
            transform innovative concepts into successful ventures.
          </p>
        </div>
        <div className="w-full lg:w-2/6 flex-col flex items-center  justify-items-start p-10 md:p-14 z-10">
          ...
          <p className="text-center">
            At SIIF, we offer comprehensive support through well-equipped
            co-working spaces, mentorship, funding opportunities, and networking
            events, empowering startups to thrive in a vibrant ecosystem.
          </p>
        </div>
        <div className="w-full lg:w-2/6 flex-col flex items-center  justify-items-start p-10 md:p-14 z-10">
          ...
          <p className="text-center">
            We support aspiring entrepreneurs and startups from diverse
            backgrounds and industries, providing the resources and guidance
            they need to turn their ideas into impactful and enduring ventures.
          </p>
        </div>
      </div>
...
<div class="elfsight-app-b31bdbf0-42b0-48fd-bb5d-0171fa681bd9" data-elfsight-app-lazy></div>
      </div> */}
