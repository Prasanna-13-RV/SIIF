...
export const PreviousEventHero = () => {
	return (
		<section className="relative bg-[url(https://blog.xoxoday.com/content/images/2022/01/Your-Complete-Guide-to-Maximizing-Conversions-from-On-Ground-Events.jpg)] bg-cover bg-center bg-no-repeat">
