	...
	return (
		<section className="flex relative items-center justify-center w-full my-3 mx-auto max-w-screen-xl sm:px-6 lg:flex flex-row flex-wrap lg:items-center lg:px-8">
			<BlogSingleCard
				...
				title={"Our Partners"}
				description={"The Startup lab, an angel network made a stratagic partnership win AIC RAISE. Through this collaboration..."}
				link={
			...
			<BlogSingleCard
				...
				title={"Delegates"}
				description={"AIC Raise recently extended a warm welcome to delegates hailing from diverse educational institutions...."}
				link={
					"https://codetheweb.blog/2017/10/09/basic-types-of-html-tags/"
				}
			/>
			<BlogSingleCard
				...
				description={"We are thrilled to announce that one of our startup WATTELLO has emerged victorious in securing funding!..."}
				link={
					"https://codetheweb.blog/2017/10/09/basic-types-of-html-tags/"
				}
			/>
