  ...
  return (
    <section className="relative items-center justify-center w-full my-3 mx-auto max-w-screen-xl sm:px-6 lg:flex flex-row flex-wrap lg:items-center lg:px-8">
      <BlogSingleCard
        ...
        title={"Our Partners"}
        description={
          "The Startup lab, an angel network made a stratagic partnership win SIIF. Through this collaboration..."
        }
      ...
      <BlogSingleCard
        ...
        title={"Delegates"}
        description={
          "SIIF recently extended a warm welcome to delegates hailing from diverse educational institutions...."
        }
        link={"https://codetheweb.blog/2017/10/09/basic-types-of-html-tags/"}
      />
      <BlogSingleCard
