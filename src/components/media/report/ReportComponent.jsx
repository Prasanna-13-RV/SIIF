...
export const ReportComponent = () => {
  ...
  return (
    <header className="bg-white">
      ...
      <div className="flex flex-col relative justify-center items-center px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-2 lg:flex-row lg:flex-wrap lg:items-center lg:justify-center">
