...
export const StateFundingContent = () => {
  return (
    <>
            ...
            <div className="lg:mx-auto lg:w-full px-8 flex flex-row flex-wrap">
              <div className="lg:mx-auto  lg:w-2/3 lg:max-w-7xl lg:gap-x-8 lg:px-8">
                <div className="text-base leading-7 text-gray-700 ">
                  <p className="pt-3">
                    The Entrepreneurship Development and Innovation Institute
                    (EDII), Chennai is an apex organisation in the field of
                    entrepreneurship education and self-employment promotion in
                    the state of Tamil Nadu.
                  </p>
                  <ul className="mt-4 space-y-1 text-gray-600 list-disc pl-4">
                    <li>Established in 2001</li>
                    <li>
                      EDII was constituted by Government of Tamil Nadu as a
                      not-for- profit society and is administered by Department
                      of Micro, Small and Medium Enterprises (MSME).
                    </li>
                    <li>
                      It is headed by the Director of the Institute, EDII is
                      managed under the superintendence of a Governing Council
                      One of the most prominent programmes offered under EDII is
                      the Innovation Voucher Programme
                    </li>
                  </ul>
                </div>
              </div>
              <div className="w-1/3 sm:w-96">
                <img
            ...
            <div className="lg:mx-auto  lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8">
              <div className="lg:pr-4 w-full">
                <div>
                  ...
                  <p className="pt-3">
                    Innovation Voucher Programme is the Tamil Nadu Government's
                    flagship grant-in-aid scheme for supporting Start-ups and
                    MSMEs.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="mt-4 space-y-1 text-gray-600 list-disc pl-4">
                    <li>Established in 2001</li>
                    <li>
                      Promoting Research and Innovation amongst Start-ups and
                      MSMEs
                    </li>
                    <li>
                      Companies working at innovative research can avail grant
                      up to Rs.5 lakhs
                    </li>
                  </ul>
                  <h1 className="mt-2 text-base font-bold tracking-tight text-gray-900 sm:text-lg">
                    The IVP programme can be divided into two types :
                  </h1>
                </div>
              </div>
            </div>
      ...
      <StateFundingTable />
      <div className="lg:mx-auto lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8 my-3 sm:p-6">
        <h1 className="mt-2 text-base font-bold tracking-tight text-gray-900 sm:text-lg">
          Eligibility Criteria
        </h1>
        <p className="pt-3">
          IVP is open to all manufacturing or service MSME/Startup willing to
          innovate and improve their business. However, the following
          eligibility conditions need to be met:
        </p>
        <ul className="mt-4 space-y-1 text-gray-600 list-disc pl-4">
        ...
        <h1 className="mt-2 text-base font-bold tracking-tight text-gray-900 sm:text-lg">
          CIIC IVP Grant Recipients: So far the total beneficiaries No. 56,
          Rs.159.13 lakhs
        </h1>
      </div>
    </>
