...
export const StateFundingHero = () => {
	return (
		<section className="relative bg-[url(https://cdn.pixabay.com/photo/2023/12/10/19/08/judgment-8442199_640.png)] bg-cover bg-center bg-no-repeat">
